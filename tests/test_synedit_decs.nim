...
echo "Decs after adding: ", ed.lineBgDecorations.len
for d in ed.lineBgDecorations:
  echo "  line=", d.line

ed.clearLineBgDecorations()
echo "Decs after clear: ", ed.lineBgDecorations.len

ed.setLineBgDecoration(0, color(0, 0, 255, 50))
ed.setLineBgDecoration(2, color(255, 255, 0, 50))
echo "Decs after re-adding: ", ed.lineBgDecorations.len
for d in ed.lineBgDecorations:
  echo "  line=", d.line

ed.setText("new0\nnew1\nnew2")
echo "Decs after setText: ", ed.lineBgDecorations.len
for d in ed.lineBgDecorations:
  echo "  line=", d.line
